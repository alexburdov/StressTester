...
#define DEFAULT_HOW_MANY_THREADS 500 // Количество запускаемых threads с опросом Rest сервиса
#define DEFAULT_NUMBER_OF_CYCLES 1000000 // Циклов опроса в threads
