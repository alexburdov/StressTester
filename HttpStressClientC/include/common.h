...
#define DEFAULT_HOW_MANY_THREADS 2
#define DEFAULT_NUMBER_OF_CYCLES 1000000
#define DEFAULT_ADD_THREAD_BATCH_SIZE 2
#define DEFAULT_ADD_THREAD_TIME_IN_SECONDS 1
#define DEFAULT_MAX_ADD_COUNT 10

#define DEFAULT_FAILURE_THRESHOLD 100
